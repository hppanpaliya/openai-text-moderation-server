    ...
    <mj-body>
      <mj-section background-color="#f0f0f0" padding="0">
        <mj-column>
          ...
          <mj-text>We noticed that a message you posted in the chat group was flagged for concerning content. We want you to know that we care about you and are here to support you.</mj-text>
          <mj-text>Please know that you are not alone and that there are resources available to help you. If you need someone to talk to, please don't hesitate to reach out.</mj-text>
